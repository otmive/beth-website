    ...
    <main>
      <section style={{ marginBottom: '3rem' }}>
        ...
        <div style={{ 
          ...
          <div>
            <p style={{ lineHeight: '1.7', marginBottom: '1.5rem', color: '#374151', fontSize: '1rem' }}>
          ...
          <div>
            ...
            <div style={{ 
              ...
              <ul style={{ margin: 0, paddingLeft: '1.5rem', color: '#374151', fontSize: '1rem' }}>
      ...
      <section style={{ marginBottom: '3rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem' }}>
          <div style={{
            ...
            <h3 style={{ marginBottom: '1rem', color: '#1f2937', fontSize: '1.2rem' }}>
      ...
      <section style={{ marginBottom: '3rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div style={{
            ...
            <p style={{ margin: 0, lineHeight: '1.7', color: '#374151', fontSize: '1rem' }}>
